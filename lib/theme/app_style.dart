...
class TextStyles {
  static const TextStyle plusJakartaSans = TextStyle(
  ...
  static TextStyle get h2 =>
      _createTextStyle(style: plusJakartaSans, fontSize: FontSizes.s24);

  static TextStyle get h3 =>
      _createTextStyle(style: plusJakartaSans, fontSize: FontSizes.s18);
