...
import 'package:drup/features/passenger/ui/screens/delivery_details_screen.dart';
...
class AppScreens {
  ...
  static final deliveryDetailsRoute = GoRoute(
    parentNavigatorKey: rootNavigator,
    path: AppRoutes.deliveryDetailsRoute,
    pageBuilder: (context, state) {
      final deliveryId = state.extra as String;
      return slideRightTransitionPage(
        key: state.pageKey,
        child: DeliveryDetailsScreen(deliveryId: deliveryId),
      );
    },
  );
